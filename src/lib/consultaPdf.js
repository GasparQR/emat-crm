...
export const buildConsultaFileName = (consulta) => {
...
export const buildConsultaPdf = (consulta) => {
  ...
  const subtotal =
    ...
    0;
  const ivaRate = parseIvaPercent(c.iva, 21);
  ...
  doc.setFont("helvetica", "bold");
  doc.text(`IVA ${formatIvaLabel(ivaRate)}%`, subtotalColX, contentY);
  doc.setFont("helvetica", "normal");
