...
const LOGO_WIDTH_MM = LOGO_HEIGHT_MM * LOGO_ASPECT;
...
export const buildConsultaPdf = (consulta) => {
  ...
  try {
    doc.addImage(EMAT_LOGO_BASE64, "PNG", 14, 3, LOGO_WIDTH_MM, LOGO_HEIGHT_MM, undefined, "FAST");
    logoRendered = true;
  } catch {}
  if (!logoRendered) {
    try {
      doc.addImage(EMAT_LOGO_DATA_URI, "PNG", 14, 3, LOGO_WIDTH_MM, LOGO_HEIGHT_MM, undefined, "FAST");
      logoRendered = true;
    } catch {}
  }
  if (!logoRendered) {
