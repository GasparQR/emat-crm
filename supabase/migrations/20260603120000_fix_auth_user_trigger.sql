-- Fix: al crear usuario en Auth, el trigger insertaba usuario.asesor_codigo (FK)
-- antes de existir la fila en public.asesor → "Database error creating new user".
...
BEGIN
  ...
  -- 1) Catálogo asesor primero (FK usuario.asesor_codigo → asesor.codigo)
